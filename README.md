...
```javascript
import lapack from 'https://cdn.jsdelivr.net/gh/stdlib-js/lapack@v0.1.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { base } from 'https://cdn.jsdelivr.net/gh/stdlib-js/lapack@v0.1.2-esm/index.mjs';
```
